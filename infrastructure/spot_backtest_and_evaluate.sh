...
EVAL_CMD="set -eo pipefail; cd ~/alpha-engine-backtester && sudo -u ec2-user git pull && sudo -u ec2-user bash -c 'source .venv/bin/activate && python evaluate.py --mode ${EVAL_MODE} --upload 2>&1'"
